...
const en: Dict = {
  ...
  risk_guide_label:      'How to use this',
  risk_guide_low:        'Your portfolio looks healthy. Keep your discipline and position sizing.',
  risk_guide_moderate:   'Manageable risk — keep an eye on the main driver below.',
  risk_guide_high:       'Elevated risk — consider acting on the main driver first.',
  risk_tip_concentration:'Most of your risk is concentration — one position is a big share of the book. Trimming it spreads the risk.',
  risk_tip_speculative:  'Most of your risk is speculative — adding core/anchor positions would balance it out.',
  risk_tip_drawdown:     'Most of your risk is deep losers — review whether their thesis still holds, or cut them.',
...
const zh: Dict = {
  ...
  risk_guide_label:      '怎么用',
  risk_guide_low:        '组合风险健康,保持纪律和仓位管理就好。',
  risk_guide_moderate:   '风险适中——留意下方的主要来源。',
  risk_guide_high:       '风险偏高——建议优先处理下方的主要来源。',
  risk_tip_concentration:'风险主要来自集中度——单一仓位占比偏大,适度减仓可以分散风险。',
  risk_tip_speculative:  '风险主要来自投机仓位——可考虑增加核心/压舱持仓来平衡。',
  risk_tip_drawdown:     '风险主要来自深度套牢的仓位——检查它们的逻辑是否还成立,或考虑止损。',
